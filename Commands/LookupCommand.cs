...
namespace Functions_for_Dynamics_Operations
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class LookupCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LookupCmd"/> class.
        ...
        /// </summary>
        public static LookupCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in LookupCmd's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;
            Instance = new LookupCommand(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ex.Log("Unable to create lookup");
            }
        }
    }
}
