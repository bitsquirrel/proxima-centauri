...
namespace Functions_for_Dynamics_Operations
{
    ...
    internal sealed class FindCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FindCmd"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in FindCmd's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {   // Only works on tables
                    DynTableFieldEdt tablefieldedt = DynaxUtils.GetAXTableFieldAndEdtAltIndex(table);
