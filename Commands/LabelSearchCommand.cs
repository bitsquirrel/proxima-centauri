...
namespace Functions_for_Dynamics_Operations
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class LabelSearchCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static LabelSearchCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in LabelSearchCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new LabelSearchCommand(package, commandService);
        }
