...
namespace Functions_for_Dynamics_Operations
{
    ...
    internal sealed class ExistsCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExistsCmd"/> class.
        ...
        /// </summary>
        public static ExistsCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in ExistsCmd's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;
            Instance = new ExistsCommand(package, commandService);
        }
