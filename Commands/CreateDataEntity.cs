...
namespace Functions_for_Dynamics_Operations
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CreateDataEntity
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        public const int CommandId = 25678;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDataEntity"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private CreateDataEntity(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CreateDataEntity Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in CreateDataEntity's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new CreateDataEntity(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (oAVSProjectFileItem.Object != null)
                {
                    ...
                    {
                        case nameof(AxTable):
                            new DataEntityFunc(vSProjectFileNode.Name).CreateDataEntity();
                            break;
                        case nameof(AxDataEntityView):
                            VSProjectNode vSProjectNode = VStudioUtils.GetSelectedProjectOrFirstActiveProject();
                            AxDataEntityView entity = vSProjectNode.DesignMetaModelService.GetDataEntityView(vSProjectFileNode.Name);
                            break;
                    }
                }
            }
            ...
            {
                ex.Log("Unable to create data entity");
            }
        }
    }
}
