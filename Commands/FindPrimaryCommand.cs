...
namespace Functions_for_Dynamics_Operations
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class FindPrimaryCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FindPrimaryCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private FindPrimaryCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static FindPrimaryCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in FindPrimaryCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new FindPrimaryCommand(package, commandService);
        }
            ...
            try
            {
                ...
                {   // Only works on tables
                    ...
                    if (tablefieldedt != null)
                        textSelection.Insert(DynaxUtils.FindCode(tablefieldedt, "find"), 1);
